...
from transformers import AutoTokenizer, BertForQuestionAnswering, TrainingArguments, default_data_collator
...
POST_FIX = "_MURIL_LARGE_CASED_WITH_SQUADV2_384"
...
def train_fold(fold, model_class):
    ...
    train = pd.concat([squadv2, external_train] + 4 * [train]).reset_index(drop=True)
...
if __name__ == "__main__":
    ...
    args = ap.parse_args()
    MODEL_CLASS = CustomBERTForQuestionAnswering
